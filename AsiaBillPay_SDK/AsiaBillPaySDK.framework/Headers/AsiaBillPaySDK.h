...
//! Project version number for AsiaBillPaySDK.
FOUNDATION_EXPORT double AsiaBillPaySDKVersionNumber;

//! Project version string for AsiaBillPaySDK.
FOUNDATION_EXPORT const unsigned char AsiaBillPaySDKVersionString[];
